 ...
 * -----------------------------------------------------------------------
 * Author: Sifan Terefe
 * Purpose: Implementation of the Exit/Utility Module. See exit_utility.h
 *          for the public interface and Exit_Utility_Module_Design.md
...
ChampionshipRecord buildChampionshipPath(const Bracket* bracket, const Team* champion) {
    ...
    record.pathRounds = malloc(count * sizeof(int));
